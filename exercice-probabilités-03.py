...
print(f"Il y a {percentage:.0f} % de chance d'avoir pile & pile & plie/face avec trois lancers")
...
print(f"Il y a {percentage:.0f} % de chance d'avoir au moins deux fois pile avec trois lancers")
